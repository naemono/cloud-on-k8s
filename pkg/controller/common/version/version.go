...
var (
	...
	// 9.2.2 is the first version of the package registry that supports UBI images, which is the default.
	SupportedPackageRegistryVersions = MinMaxVersion{Min: From(9, 2, 2), Max: From(9, 99, 99)}
